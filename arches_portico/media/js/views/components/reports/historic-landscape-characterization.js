define([
    ...
    return ko.components.register('historic-landscape-characterization-report', {
        viewModel: function(params) {
            ...
            // For Portico, we don't use the AfHER default HLC attributes and instead implement new ones
                    ...
                    [
                        {
                            ...
                            data: [{
                                key: 'Pattern',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'pattern'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Parcel',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'parcel'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Boundary',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'boundary'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Dominant External',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'dominant external'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Dominant Internal',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'dominant internal'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Secondary External',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'secondary external'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Secondary Internal',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'secondary internal'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            },{
                                key: 'Boundary Change',
                                value: self.getNodeValue(self.resource(), 'historic land use character attributes', 'boundary change'),
                                type: 'kv',
                                card: self.cards?.['historic land use character attributes']
                            }]
                        }
