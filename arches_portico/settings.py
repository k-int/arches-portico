"""
Django settings for arches_portico project.
"""
...
DATATYPE_LOCATIONS.append('arches_portico.datatypes')
FUNCTION_LOCATIONS.append('arches_portico.functions')
...
ELASTICSEARCH_PREFIX = 'arches_portico'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_portico.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'arches_portico.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_portico'
